import {
  TimesIcon
} from "./chunk-2E3JH4G6.js";
import {
  CSSTransition
} from "./chunk-VPWPOJQI.js";
import {
  TransitionGroup_default
} from "./chunk-RMAPONUR.js";
import "./chunk-GB5MV2FE.js";
import "./chunk-H34UXRLQ.js";
import {
  Button
} from "./chunk-QOLJZBVF.js";
import {
  Ripple
} from "./chunk-GEG6VMFY.js";
import {
  IconBase
} from "./chunk-ZHIWHVDU.js";
import "./chunk-QXB4QD6L.js";
import {
  useTimeout
...
var ObjectUtils2 = function() {
  ...
  _createClass(ObjectUtils7, null, [{
    ...
    value: function resolveFieldData(data, field) {
      if (data && Object.keys(data).length && field) {
        if (this.isFunction(field)) {
          return field(data);
        } else if (ObjectUtils7.isNotEmpty(data[field])) {
          return data[field];
    ...
    key: "combinedRefs",
    value: function combinedRefs(innerRef, forwardRef10) {
      if (innerRef && forwardRef10) {
        if (typeof forwardRef10 === "function") {
          forwardRef10(innerRef.current);
        } else {
          forwardRef10.current = innerRef.current;
        }
      }
    }
  }, {
    ...
    value: function sort(value1, value2) {
      ...
      var result = ObjectUtils7.compare(value1, value2, locale, order);
      var finalSortOrder = order;
      if (ObjectUtils7.isEmpty(value1) || ObjectUtils7.isEmpty(value2)) {
    ...
    value: function compare(value1, value2, locale) {
      ...
      var result = -1;
      var emptyValue1 = ObjectUtils7.isEmpty(value1);
      var emptyValue2 = ObjectUtils7.isEmpty(value2);
...
var ExclamationTriangleIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React4.useState(inProps.id), _React$useState2 = _slicedToArray3(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
var InfoCircleIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React5.useState(inProps.id), _React$useState2 = _slicedToArray4(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
...
var TimesCircleIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  var _React$useState = React6.useState(inProps.id), _React$useState2 = _slicedToArray5(_React$useState, 2), pathId = _React$useState2[0], setPathId = _React$useState2[1];
  ...
  return React6.createElement("svg", _extends6({
    ...
    fill: "currentColor"
  })), React6.createElement("defs", null, React6.createElement("clipPath", {
    id: pathId
...
var UIMessage = React7.memo(React7.forwardRef(function(props, ref) {
  var messageInfo = props.message, parentMetaData = props.metaData, _props$ptCallbacks = props.ptCallbacks, ptm = _props$ptCallbacks.ptm, ptmo = _props$ptCallbacks.ptmo, index = props.index;
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (closable !== false) {
      ...
      var icon = _closeIcon || React7.createElement(TimesIcon, buttonIconProps);
      ...
      return React7.createElement("button", buttonProps, _closeIcon2, React7.createElement(Ripple, null));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (props.message) {
      ...
      if (!_icon) {
        switch (severity) {
          case "info":
            icon = React7.createElement(InfoCircleIcon, iconProps);
            break;
          case "warn":
            icon = React7.createElement(ExclamationTriangleIcon, iconProps);
            break;
          case "error":
            icon = React7.createElement(TimesCircleIcon, iconProps);
            break;
          case "success":
            icon = React7.createElement(CheckIcon, iconProps);
            break;
        }
      }
      ...
      return content || React7.createElement(React7.Fragment, null, iconContent, React7.createElement("span", summaryProps, summary), React7.createElement("span", detailProps, detail));
    }
    return null;
  };
  ...
  return React7.createElement("div", rootProps, React7.createElement("div", wrapperProps, message, closeIcon));
}));
UIMessage.displayName = "UIMessage";
var messageIdx = 0;
var Messages = React7.memo(React7.forwardRef(function(inProps, ref) {
  var context = React7.useContext(PrimeReactContext);
  var props = MessagesBase.getProps(inProps, context);
  var _React$useState = React7.useState([]), _React$useState2 = _slicedToArray6(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  return React7.createElement("div", rootProps, React7.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(message, index) {
    var messageRef = React7.createRef();
    return React7.createElement(CSSTransition, {
      nodeRef: messageRef,
      key: message._pId,
    ...
    }, React7.createElement(UIMessage, {
      ref: messageRef,
      message,
...
var ProgressBar = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React8.createElement("div", rootProps, React8.createElement("div", valueProps, props.value != null && props.value !== 0 && props.showValue && React8.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React8.createElement("div", rootProps, React8.createElement("div", indeterminateContainerProps, React8.createElement("div", valueProps)));
  };
...
var Badge = React9.memo(React9.forwardRef(function(inProps, ref) {
  ...
  var className = classNames("p-badge p-component", _defineProperty2({
  ...
  return React9.createElement("span", rootProps, props.value);
}));
...
var FileUpload = React9.memo(React9.forwardRef(function(inProps, ref) {
  var context = React9.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React9.useState([]), _React$useState2 = _slicedToArray7(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React9.useState([]), _React$useState4 = _slicedToArray7(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React9.useState(0), _React$useState6 = _slicedToArray7(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  var _React$useState7 = React9.useState(false), _React$useState8 = _slicedToArray7(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React9.useState(false), _React$useState10 = _slicedToArray7(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  ...
  var fileInputRef = React9.useRef(null);
  var messagesRef = React9.useRef(null);
  var contentRef = React9.useRef(null);
  var duplicateIEEvent = React9.useRef(false);
  var uploadedFileCount = React9.useRef(0);
  ...
  var clearIEInput = function clearIEInput2() {
    if (fileInputRef.current) {
      duplicateIEEvent.current = true;
      fileInputRef.current.value = "";
    }
  };
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React9.createElement("span", _extends7({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React9.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React9.createElement("input", inputProps);
    var chooseIconProps = mergeProps({
      className: iconClassName
    }, ptm("chooseIcon"));
    var icon = _icon || React9.createElement(PlusIcon, chooseIconProps);
    var chooseIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, chooseIconProps), {
      props
    });
    ...
    return React9.createElement("span", chooseButtonProps, input, chooseIcon, label, React9.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React9.createElement("img", _extends7({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React9.createElement("div", fileNameProps, file.name);
    var size = React9.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React9.createElement("div", detailsProps, React9.createElement("div", fileNameProps, " ", file.name), React9.createElement("span", fileSizeProps, formatSize(file.size)), React9.createElement(Badge, {
      className: "p-fileupload-file-badge",
      value: badgeOptions.value,
      severity: badgeOptions.severity,
      pt: ptm("badge")
    }));
    var removeButton = React9.createElement("div", actionsProps, React9.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React9.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React9.createElement(React9.Fragment, null, preview, contentBody, removeButton);
    ...
    return React9.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React9.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React9.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar")
    });
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon = IconUtils.getJSXIcon(uploadOptions.icon || React9.createElement(UploadIcon, uploadIconProps), _objectSpread2({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon = IconUtils.getJSXIcon(cancelOptions.icon || React9.createElement(TimesIcon, cancelIconProps), _objectSpread2({}, cancelIconProps), {
        props
      });
      uploadButton = React9.createElement(Button, {
        type: "button",
        label: uploadLabel,
        icon: uploadIcon,
        onClick: upload,
      ...
      cancelButton = React9.createElement(Button, {
        type: "button",
        label: cancelLabel,
        icon: cancelIcon,
        onClick: clear,
    ...
    var header = React9.createElement("div", buttonbarProps, chooseButton, uploadButton, cancelButton);
    ...
    return React9.createElement("div", rootProps, header, React9.createElement("div", contentProps, progressBar, React9.createElement(Messages, {
      ref: messagesRef
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React9.createElement("span", _extends7({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React9.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React9.createElement("span", labelProps, hasFiles ? filesState[0].name : chooseLabel);
    ...
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React9.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React9.createElement(UploadIcon, chooseIconProps);
    var chooseIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React9.createElement("input", inputProps);
    var rootProps = mergeProps({
      className,
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React9.createElement("div", rootProps, React9.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message")
    }), React9.createElement("span", basicButtonProps, chooseIcon, label, input, React9.createElement(Ripple, null)));
  };
  if (props.mode === "advanced")
