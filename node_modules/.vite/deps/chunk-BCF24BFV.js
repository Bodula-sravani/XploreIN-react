import {
  Ripple
} from "./chunk-DMARIQ7Q.js";
import {
  IconBase
} from "./chunk-TPHD23I5.js";
import {
  Tooltip
} from "./chunk-3WHBYFS4.js";
import {
  ComponentBase,
  IconUtils,
  ObjectUtils,
...
var Button = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var createIcon = function createIcon2() {
    ...
    var icon2 = props.loading ? props.loadingIcon || React2.createElement(SpinnerIcon, _extends2({}, loadingIconProps, {
      spin: true
    })) : props.icon;
  ...
  var createBadge = function createBadge2() {
    if (props.badge) {
      ...
      return React2.createElement("span", badgeProps, props.badge);
    }
    return null;
  };
  ...
  return React2.createElement(React2.Fragment, null, React2.createElement("button", rootProps, icon, label, props.children, badge, React2.createElement(Ripple, null)), hasTooltip && React2.createElement(Tooltip, _extends2({
    target: elementRef,
...
//# sourceMappingURL=chunk-BCF24BFV.js.map
